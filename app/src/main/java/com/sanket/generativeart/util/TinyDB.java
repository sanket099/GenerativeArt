...
public class TinyDB {
    ...
    public int getIntDensity(String key) {
    ...
    public ArrayList<MyColor> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<MyColor> objects =  new ArrayList<MyColor>();

    	for(String jObjString : objStrings){
    		MyColor value  = (MyColor) gson.fromJson(jObjString, mClass);
    		objects.add(value);
    	}
    	return objects;
    }
     ...
     */
    public void putObject(String key, MyColor obj){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	putString(key, gson.toJson(obj));
    }

    public void putListObject(String key, ArrayList<MyColor> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
